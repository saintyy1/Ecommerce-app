...
const Checkout = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const callbackUrl = "http://localhost:5173/order-confirmation";
      const response = await fetch("https://paystack-integration-w386.onrender.com/api/initialize-transaction", {
        method: "POST",
        headers: {
